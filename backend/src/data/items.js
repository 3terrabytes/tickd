const RARITIES = {
  junk:      { label: 'Junk',      color: '#6b5c3e', glow: '#6b5c3e33', magic: [0, 0] },
...
const ITEMS = [
  // JUNK WEAPONS
  { id: 'stick',          type: 'weapon', name: 'A Stick',           rarity: 'junk', cost: 5,  magic: 0, emoji: '🥢', desc: 'Just a stick. You found it outside.' },
  { id: 'spoon_rusty',    type: 'weapon', name: 'Rusty Spoon',        rarity: 'junk', cost: 8,  magic: 0, emoji: '🥄', desc: 'Bent and slightly sticky.' },
  { id: 'umbrella_broke', type: 'weapon', name: 'Broken Umbrella',    rarity: 'junk', cost: 10, magic: 0, emoji: '☂️', desc: 'Flips inside out in a light breeze.' },
  { id: 'baguette',       type: 'weapon', name: 'Stale Baguette',     rarity: 'junk', cost: 6,  magic: 0, emoji: '🥖', desc: 'Could take an eye out at this point.' },
  { id: 'pencil_chewed',  type: 'weapon', name: 'Chewed Pencil',      rarity: 'junk', cost: 4,  magic: 0, emoji: '✏️', desc: 'The eraser end is long gone.' },
  { id: 'slipper',        type: 'weapon', name: 'Old Slipper',        rarity: 'junk', cost: 7,  magic: 0, emoji: '🥿', desc: 'Floppy but surprisingly threatening.' },

  // JUNK ARMOR
  { id: 'bin_lid',        type: 'armor',  name: 'Bin Lid Shield',     rarity: 'junk', cost: 8,  magic: 0, emoji: '🪣', desc: 'Smells faintly of last Tuesday.' },
  { id: 'cardboard_box',  type: 'armor',  name: 'Cardboard Box',      rarity: 'junk', cost: 6,  magic: 0, emoji: '📦', desc: 'Waterproof until it isn''t.' },
  { id: 'bubble_wrap',    type: 'armor',  name: 'Bubble Wrap Suit',   rarity: 'junk', cost: 12, magic: 0, emoji: '📫', desc: 'Very satisfying to pop. Not very protective.' },
  { id: 'oven_mitt',      type: 'armor',  name: 'Oven Mitt Gauntlet', rarity: 'junk', cost: 5,  magic: 0, emoji: '🧤', desc: 'Floral pattern. One size fits none.' },

  // JUNK BANNERS
  { id: 'banner_beige',   type: 'banner', name: 'Beige Banner',       rarity: 'junk', cost: 5,  magic: 0, color: 'linear-gradient(90deg,#c8b89a,#d4c4a8)', desc: 'The most aggressively average colour.' },
  { id: 'banner_grey',    type: 'banner', name: 'Grey Banner',         rarity: 'junk', cost: 5,  magic: 0, color: 'linear-gradient(90deg,#4a4a4a,#6a6a6a)', desc: 'Like a rainy Tuesday morning.' },

  // JUNK BADGES
  { id: 'badge_poop',     type: 'badge',  name: 'Poop Badge',         rarity: 'junk', cost: 3,  magic: 0, emoji: '💩', desc: 'At least you''re honest about it.' },
  { id: 'badge_snail',    type: 'badge',  name: 'Snail Badge',         rarity: 'junk', cost: 4,  magic: 0, emoji: '🐌', desc: 'Slow and proud.' },
  { id: 'badge_white',    type: 'badge',  name: 'Plain White Badge',   rarity: 'junk', cost: 2,  magic: 0, emoji: '⬜', desc: 'Someone forgot to design this.' },
