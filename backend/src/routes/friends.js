...
router.get('/all', async (req, res) => {
  ...
  const { rows } = await pool.query(`
    SELECT u.id, u.username, u.level, u.avatar_color, u.avatar_skin, u.avatar_hair, u.avatar_eyes, u.avatar_hair_style,
...
router.get('/pending', async (req, res) => {
  const { rows } = await pool.query(`
    SELECT u.id, u.username, u.level, u.avatar_color, u.avatar_skin, u.avatar_hair, u.avatar_eyes, u.avatar_hair_style, f.created_at,
      e.weapon AS eq_weapon, e.armor AS eq_armor, e.banner AS eq_banner, e.badge AS eq_badge
...
router.get('/', async (req, res) => {
  ...
  const { rows } = await pool.query(`
    SELECT u.id, u.username, u.xp, u.level, u.avatar_color, u.avatar_skin, u.avatar_hair, u.avatar_eyes, u.avatar_hair_style,
      e.weapon AS eq_weapon, e.armor AS eq_armor, e.banner AS eq_banner, e.badge AS eq_badge,
