...
export default function PixelCharacter({ equipped = {}, appearance = {}, size = 120 }) {
  ...
  const beard     = appearance.avatar_beard      || 0;
  ...
  return (
    <div style={{ width: size, height: size, flexShrink: 0, imageRendering: 'pixelated' }}>
      <svg width={size} height={size} viewBox="0 0 80 90" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
        ...
        {/* Beard */}
        {beard === 1 && <>
          <rect x="32" y="32" width="16" height="2" fill={darken(hair)} opacity="0.6"/>
        </>}
        {beard === 2 && <>
          <rect x="30" y="32" width="20" height="3" fill={hair}/>
          <rect x="28" y="30" width="4"  height="4" fill={hair}/>
          <rect x="48" y="30" width="4"  height="4" fill={hair}/>
        </>}
        {beard === 3 && <>
          <rect x="28" y="30" width="24" height="8" fill={hair}/>
          <rect x="26" y="28" width="4"  height="6" fill={hair}/>
          <rect x="50" y="28" width="4"  height="6" fill={hair}/>
          <rect x="30" y="37" width="4"  height="4" fill={hair}/>
          <rect x="46" y="37" width="4"  height="4" fill={hair}/>
        </>}
        {beard === 4 && <>
          <rect x="32" y="29" width="16" height="3" fill={hair}/>
          <rect x="30" y="28" width="4"  height="2" fill={hair}/>
          <rect x="46" y="28" width="4"  height="2" fill={hair}/>
        </>}
