...
> Level up your life, one habit at a time. A gamified habit tracker with XP, levels, streaks, a pixel avatar, a deep item shop (now with themed sets and discounted bundles), friends, gifting, and more.
...
- **🛒 Item Shop** — Weapons, armour, banners, badges, companions, titles, and consumables across four rarities
- **🌊 Themed Sets** — Frog, Tidecaller, Phoenix, Frost, Sakura, Cyber, Buccaneer, Harvest, and Lunar — full themed kits across every slot
- **🎁 Item Bundles** — Buy whole themed sets at a discount (up to ~25% off vs grabbing items individually)
- **🔎 Shop Search & Sort** — Search by name/theme, sort by price / rarity / magic / name, filter by rarity, plus *hide-owned* and *affordable-only* toggles
- **🧪 Consumables** — One-shot boosts: XP potions, Gold Pouch, Streak Scroll, Birthday Cake, Doubler Scroll, and a Stale Baguette
...
Spend gold in the **Shop** tab on your avatar page. Items live in one of seven slots:

| Slot | Examples |
|------|----------|
| 🗡️ Weapon    | Iron Sword, Storm Bow, Soul Blade, Void Staff |
| 🛡️ Armor     | Leather Armor, Mage Robes, Dragonscale Mail, Phoenix Cloak |
| 🏷️ Banner    | Crimson, Galaxy, Aurora, Lunar, Phoenix… |
| 🎖️ Badge     | Flame, Crown, Dragon, Legend, Infinity… |
| 🐾 Companion | Habit Cat, Spirit Fox, Wise Owl, Mini Dragon |
| 📛 Title     | "The Grinder", "The Eternal", "Of the Deep" |
| 🧪 Consumable | XP Potions, Gold Pouch, Streak Scroll, Birthday Cake, Doubler Scroll |

Every item is **Common**, **Rare**, **Epic**, or **Legendary** — higher rarity = more cost, more Magic Power, more flex.

### 🎁 Bundles

Themed bundles bundle a full themed set (often 6–7 items) at a discount versus buying piece-by-piece. Bundles are **all-or-nothing**: if you already own any item inside the bundle, the purchase is refused and you can grab the rest individually instead.

Available bundles include: Starter, Frog, Tidecaller, Phoenix, Frost, Sakura, Cyber, Buccaneer, Harvest, Lunar, and the Adventurer's Stash (consumable pile).

### 🔎 Sort & Filter

The Shop tab exposes:
- **Type filter** — All / Packs / Weapon / Armor / Banner / Badge / Companion / Title / Consumable
- **Rarity filter** — Any / Common / Rare / Epic / Legendary
- **Search** — by name, description, or theme keyword
- **Sort** — Default / Price ↑↓ / Rarity ↑↓ / Magic ↓ / Name A→Z
- **Toggles** — *Hide owned* and *Affordable only*
...
│       │   ├── shop.js            # Avatar shop + bundles + inventory + equip
...
│       ├── data/items.js          # Shop item definitions + bundle (PACKS) definitions
